...
public class TweetToSparseFeatureVector2 extends TweetToFeatureVector {
	...
	@OptionMetadata(displayName = "wordNgramMaxDim",
			description = "Minimum frequency of a sparse attribute to be considered in the attribute space.", 
			commandLineParamName = "wordNgramMaxDim", 
			commandLineParamSynopsis = "-wordNgramMaxDim <int>",
			displayOrder = 6)	
	...
	@OptionMetadata(displayName = "charNgramMinDim",
			description = "Minimum frequency of a sparse attribute to be considered in the attribute space.", 
			commandLineParamName = "charNgramMinDim", 
			commandLineParamSynopsis = "-charNgramMinDim <int>",
			displayOrder = 6)		
	...
	@OptionMetadata(displayName = "taggerFile",
			description = "The TweetNLP POS tagger model.",
	...
	public static void main(String[] args) {
		runFilter(new TweetToSparseFeatureVector2(), args);
	}
